...
#set equations equal to each other for optimal P and Q
...
(a) The total electricity consumption is **`r (q_solar)` kWh ** 
 

```{r}
TEC_solar <- (q_solar * MEC)/100
```

(b)The total environmental externality is $**`r (TEC_solar)`** -- NEED TO FIX 
