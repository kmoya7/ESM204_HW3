...
ggplot() +
  ...
  geom_abline(slope = (0.10*market_q), intercept = 0, color = "orange", aes(value = "supply")) + # supply curve
...
The aggregate monthly demand curve (black line) is the horizontal sum of the low income and the high income demand curves (dashed lines). The 
